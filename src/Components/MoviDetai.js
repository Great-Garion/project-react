      ...
      <Container>
        <Row className="justify-content-md-center mt-10">
          ...
          <Col xs={5} style={{ marginTop: "5rem" }}>
            <div>
              <Card.Title>
                Title : <h6>{movie.original_title}</h6>
              </Card.Title>
              <Card.Text>
                Overview : <h6>{movie.overview}</h6>
              </Card.Text>
              <Card.Text>
                Status : <h6>{movie.status}</h6>
              </Card.Text>
              <Card.Text>
                Release_date : <h6>{movie.release_date}</h6>
              </Card.Text>
              <Card.Text>
                Popularity : <h6>{movie.popularity}</h6>
              </Card.Text>
              <Card.Text>
                Original_language : <h6>{movie.original_language}</h6>
              </Card.Text>

              <Card.Text>
                Tagline : <h6>{movie.tagline}</h6>
              </Card.Text>
              <Card.Text style={{ display: "flex" }}>
                Genre :
                {movie.genres?.map((item,index) => {
                  return <h6 key={index} style={{ paddingLeft: "5px" }}>{item.name}, </h6>;
                })}
              </Card.Text>
              <Card.Text style={{ display: "flex" }}>
